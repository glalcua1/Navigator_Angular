...
export function FilterSidebar({ isOpen, onClose, onApply, initialFilters = {} }: FilterSidebarProps) {
  ...
  return (
    <div
      className={cn(
        "fixed inset-y-0 right-0 z-50 w-96 transform bg-white shadow-2xl transition-transform duration-300 ease-in-out border-l border-gray-200 dark:bg-slate-900 dark:border-slate-700 flex flex-col",
